# NOTE: This is a demo / PoC on how to build dynamic queries with joins on
# related tables. It provides a nice API that is easy to use, understand, test
# and expand (see old HE.Mob for usage example). However, it likely won't be
# used in the current Helix version. I'm keeping these tests here anyways
# until I'm sure they are not used.
defmodule DB.Query.Dynamic.BuilderTest do
  use ExUnit.Case, async: true

  alias DB.Query.Dynamic.Builder, as: B
