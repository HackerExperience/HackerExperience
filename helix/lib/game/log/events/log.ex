defmodule Game.Events.Log do
  ...
  defmodule Edited do
    @moduledoc """
    The LogEditedEvent is emitted after a Log is edited, which is the direct result of a
    LogEditProcess reaching completion.
  ...
  defmodule EditFailed do
    @moduledoc """
    The LogEditedFailedEvent is emitted when the attempt to edit a Log has failed. This may
    happen during the execution of a LogEditProcess or at its completion if the prerequisites
    are not met.
