...
CREATE TABLE connection_groups ( id INTEGER PRIMARY KEY, tunnel_id INTEGER NOT NULL, group_type TEXT NOT NULL, inserted_at TEXT NOT NULL, FOREIGN KEY (tunnel_id) REFERENCES tunnels(id) ON DELETE RESTRICT ON UPDATE RESTRICT ) STRICT;
CREATE TABLE connections ( id INTEGER PRIMARY KEY, nip TEXT NOT NULL, from_nip TEXT, to_nip TEXT, connection_type TEXT NOT NULL, group_id INTEGER NOT NULL, tunnel_id INTEGER NOT NULL, inserted_at TEXT NOT NULL, FOREIGN KEY (group_id) REFERENCES connection_groups(id) ON DELETE RESTRICT ON UPDATE RESTRICT, FOREIGN KEY (tunnel_id) REFERENCES tunnels(id) ON DELETE RESTRICT ON UPDATE RESTRICT, FOREIGN KEY (nip) REFERENCES network_connections(nip) ON DELETE RESTRICT ON UPDATE RESTRICT, FOREIGN KEY (from_nip) REFERENCES network_connections(nip) ON DELETE RESTRICT ON UPDATE RESTRICT, FOREIGN KEY (to_nip) REFERENCES network_connections(nip) ON DELETE RESTRICT ON UPDATE RESTRICT ) STRICT;
