...
CREATE TABLE logs ( id INTEGER, revision_id INTEGER NOT NULL, type TEXT NOT NULL, direction TEXT NOT NULL, data TEXT NOT NULL, inserted_at TEXT NOT NULL, UNIQUE (id, revision_id) ) STRICT;
...
CREATE TABLE files ( id INTEGER PRIMARY KEY, type TEXT NOT NULL, version INTEGER NOT NULL, size INTEGER NOT NULL, path TEXT NOT NULL, inserted_at TEXT NOT NULL, updated_at TEXT NOT NULL ) STRICT;
