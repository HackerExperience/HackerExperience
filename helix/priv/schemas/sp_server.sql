...
CREATE TABLE logs ( id INTEGER PRIMARY KEY, revision_id INTEGER NOT NULL, type TEXT NOT NULL, data TEXT NOT NULL, inserted_at TEXT NOT NULL, UNIQUE (id, revision_id) ) STRICT;
COMMIT;
