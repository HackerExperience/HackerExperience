...
CREATE TABLE logs ( id INTEGER NOT NULL, revision_id INTEGER NOT NULL, type TEXT NOT NULL, direction TEXT NOT NULL, data TEXT NOT NULL, inserted_at TEXT NOT NULL, deleted_at TEXT NULL, deleted_by INTEGER NULL, UNIQUE (id, revision_id) ) STRICT;
...
CREATE TABLE files ( id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT NOT NULL, name TEXT NOT NULL, version INTEGER NOT NULL, size INTEGER NOT NULL, path TEXT NOT NULL, inserted_at TEXT NOT NULL, updated_at TEXT NOT NULL ) STRICT;
